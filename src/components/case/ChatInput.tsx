...
const ChatInput = ({ onSendMessage, isDisabled, messages }: ChatInputProps) => {
  ...
  return (
    <div className="p-4 border-t bg-gradient-to-r from-secondary/40 to-secondary/20 rounded-b-xl shadow-inner">
      ...
      {showHistory && (
        <div ref={historyRef} className="relative z-10 w-72 shadow-md mb-4 rounded-xl overflow-hidden">
          <ChatHistory 
            messages={messages}
      ...
      >
        <Textarea 
          ...
          className="flex-1 min-h-[48px] max-h-[120px] bg-white dark:bg-card border-0 shadow-sm focus-visible:ring-primary resize-none overflow-y-auto py-3 px-4 rounded-xl transition-all duration-200"
          disabled={isDisabled}
        ...
        <Button 
          ...
          className="shrink-0 h-12 w-12 rounded-full shadow-sm hover:shadow-md transition-all duration-200"
          size="icon"
        >
